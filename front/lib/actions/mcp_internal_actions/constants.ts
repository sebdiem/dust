...
The directive should be used to display a clickable version of the agent name in the response.`,
  ...
  todo: {
    ...
    isRestricted: undefined,
    tools_stakes: {
      create_todo: "never_ask",
      update_todo: "never_ask",
      delete_todo: "never_ask",
      list_todos: "never_ask",
      get_todo: "never_ask",
      create_todolist: "never_ask",
      list_todolists: "never_ask",
      delete_todolist: "never_ask",
    },
    tools_retry_policies: undefined,
    timeoutMs: undefined,
    serverInfo: {
      name: "todo",
      version: "1.0.0",
      description: "Manage todo lists for task tracking.",
      authorization: null,
      icon: "ActionDocumentTextIcon",
      documentationUrl: null,
      instructions: null,
